  ...
  DemoScreenState() {
    ...
    if (Platform.isAndroid) {
      SipWrapper.wrapper.setLicense(
          "{Trial_quldosh@gmail.com_Android-C8D9-F767-ABDA4AB9-7081-D1D6-C378-2D5BC712901E}",
          "{hnLSzql65eDr9wRBkaa8IXCLu/Gt/TYJje4CH8bhsTVdDhTu0lpSE+sir9MGpxbj2UVZin6xpdLx1G8tHP6gBw==}"
      );
    } else if (Platform.isIOS) {
      SipWrapper.wrapper.setLicense(
          "{Trial_quldosh@gmail.com_iOS-C8D9-F747-BBDA4AB9-7081-D1D6-C378-2D5BC712901E}",
          "{obc6HB/okH3Tmdltk8CKtRpdYXoy6/7A2du486cuRgAVvKtQBRUkxmfpaojP6tIQ4mIV/u2mXZWB+BrHJNfD2g==}"
      );
    }
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      controller: teLogin = TextEditingController(
                        text: "3006" // You can put here your test credentials
                      ),
                    ),
                    SizedBox(height: 15),
                    Text('Password:'),
                    TextFormField(
                      controller: tePass = TextEditingController(
                          text: "8b1e39" // You can put here your test credentials
                      ),
                    ),
                    SizedBox(height: 15),
                    Text('Domain:'),
                    TextFormField(
                      controller: teDomain = TextEditingController(
                          text: "cld.alovoice.uz:65040" // You can put here your test credentials
                      ),
                    ),
                    SizedBox(height: 15),
