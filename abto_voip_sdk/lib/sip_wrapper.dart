...
class SipWrapper {
  ...
  void sendDtmf(int char) {
    debugPrint("SipWrapper muteLocalVideo: " + mute.toString());
    _channel?.platform?.invokeMethod(_EVENT_SEND_DTMF, mute);
  }
  ...
  void _stateChanged() {
    debugPrint("SipWrapper stateChanged " + (_channel?.value ?? ""));
...
// Channel
class SipChannel extends ValueNotifier<String> {
